...
public class Constants {
    ...
    public static final String ARGUMENTS_FORMAT_COMPRESS = "Program Arguments Format: c <input-file-path> [number of bytes]";
    public static final String ARGUMENTS_FORMAT_DECOMPRESS = "Program Arguments Format: d <input-file-path>";
